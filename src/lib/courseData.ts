  ...
  return gradYears.flatMap((year) => [
    {
      ...
      steps: [
        ...
        { id: `${gender}-film-${year}-2`, stepNumber: 2, title: "Week 1 Film Session", type: "film", content: { videoUrl: "https://www.youtube.com/watch?v=rbL9yXyCXtQ", description: "Watch this film breakdown of defensive positioning and slides. Identify 3 defensive concepts you see working and 2 breakdowns.", duration: 15 } },
        ...
        { id: `${gender}-film-${year}-4`, stepNumber: 4, title: "Week 2 Film Session", type: "film", content: { videoUrl: "https://www.youtube.com/watch?v=iTs7eKIvBhI", description: "Transition reads: watch this clip and identify the exact moment the fast break becomes available. When do you push? When do you wait?", duration: 15 } },
        ...
        { id: `${gender}-film-${year}-6`, stepNumber: 6, title: "Week 3 Film Session", type: "film", content: { videoUrl: "https://www.youtube.com/watch?v=mQi0UQz_8ls", description: "Settled 6v6 offense breakdown. Watch and pause at each dodge — before the player acts, identify the scoring opportunity. Did you see it first?", duration: 15 } },
    ...
    },
    {
      ...
      steps: [
        ...
        { id: `${gender}-skills-${year}-7`, stepNumber: 7, title: "Expansion: Self-Scout Film", type: "film", content: { videoUrl: "https://www.youtube.com/watch?v=zEtzK0HGeao", description: "Self-scout film study. Using this coaching breakdown as a model, grade yourself in your own recent game on 3 categories: positioning, decision-making, and execution.", duration: 20 } },
